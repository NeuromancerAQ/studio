...
export default class FoxgloveWebSocketPlayer implements Player {
  ...
  #playerCapabilities: (typeof PlayerCapabilities)[keyof typeof PlayerCapabilities][] = ["setSpeed", "playbackControl"];
  ...
  #startPlayImpl(opt?: { untilTime: Time }): void {
    if (this.#isPlaying || this.#untilTime || !this.#startTime || !this.#endTime) {
      return;
    }
